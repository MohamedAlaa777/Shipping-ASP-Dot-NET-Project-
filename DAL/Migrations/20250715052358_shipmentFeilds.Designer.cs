...
namespace DAL.Migrations
{
    ...
    [Migration("20250715052358_shipmentFeilds")]
    partial class shipmentFeilds
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Entities.TbCountry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("DAL.Entities.TbPaymentMethod", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("DAL.Entities.TbUserSebder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("DAL.Entities.TbUserSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("DAL.Entities.TbCity", b =>
                {
                    b.HasOne("DAL.Entities.TbCountry", "Country")
                        .WithMany("TbCities")
            ...
            modelBuilder.Entity("DAL.Entities.TbShippment", b =>
                {
                    ...
                    b.HasOne("DAL.Entities.TbUserReceiver", "Receiver")
                        .WithMany("TbShippments")
                        .HasForeignKey("ReceiverId")
                        .IsRequired()
                        .HasConstraintName("FK_TbShippments_TbUserReceivers");

                    b.HasOne("DAL.Entities.TbUserSebder", "Sender")
                        .WithMany("TbShippments")
                    ...
                    b.HasOne("DAL.Entities.TbShippingType", "ShippingType")
                        .WithMany("TbShippments")
            ...
            modelBuilder.Entity("DAL.Entities.TbUserReceiver", b =>
                {
                    b.HasOne("DAL.Entities.TbCity", "City")
            ...
            modelBuilder.Entity("DAL.Entities.TbUserSubscription", b =>
                {
                    b.HasOne("DAL.Entities.TbSubscriptionPackage", "Package")
