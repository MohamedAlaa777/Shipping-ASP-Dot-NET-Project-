...
{
    public class ShipmentQueryService : BaseService<TbShippment, ShippmentDto>, IShipmentQuery
    {
        IUserService _userService;
        IGenericRepository<TbShippment> _repo;
        public ShipmentQueryService(IGenericRepository<TbShippment> repo, IMapper mapper,
        ...
        public async Task<PagedResult<ShippmentDto>> GetShipments(int pageNumber, int pageSize, bool isUserData, ShipmentStatusEnum? status)
        {
            try
            {
                int? nStatus = 0;
